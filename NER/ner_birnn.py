...
class NER_net:
    ...
    def _build_net(self):
        ...
        self.log_likelihood, self.transition_params = tf.contrib.crf.crf_log_likelihood(
            self.outputs, self.y, np.array(BATCH_SIZE * [time_step]))
        ...
        for i in range(20000):
          ...
          if i % 20 == 0:
            ...
            for index, (tf_unary_scores_, y_, sequence_length_) in enumerate(zip(tf_unary_scores, batch_y,
              ...
              if index == 0:
                utils.display_predict(batch_x_ids[index][:sequence_length_], viterbi_sequence, id_to_word_table, id_to_tag_table)
